...
(function (root) {
  ...
  function start(opts) {
    ...
    function draw() {
      ...
      items.push({ y: me.y, f: () => { SP.drawFigure(ctx, me.x, me.y, 1.15, opts.look, opts.kit, { step: me.moving ? me.step : 0 }); ctx.fillStyle = '#ffe14d'; ctx.beginPath(); ctx.moveTo(me.x - 4, me.y - 30); ctx.lineTo(me.x + 4, me.y - 30); ctx.lineTo(me.x, me.y - 25); ctx.closePath(); ctx.fill(); } });
